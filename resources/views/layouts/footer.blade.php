        ...
        <div class="flex  flex-wrap justify-between">
          ...
          <div class="bg-gray-600">
            <div>
              ...
              <ul class="mt-4 space-y-4">
                <li>
                  <a href="{{ route('home', '#features') }}" class="text-base text-gray-200 hover:text-yellow-600 focus:outline-none  focus:ring-1 focus:ring-yellow-800 focus:border-yellow-600">
                    Features
                  </a>
                </li>

                <li>
                  <a href="{{ route('home', '#faq') }}" class="text-base text-gray-200 hover:text-yellow-600 focus:outline-none  focus:ring-1 focus:ring-yellow-800 focus:border-yellow-600">
                    Fequently Asked Questions
                  </a>
                </li>

                <li>
                  <a href="{{ route('home', '#') }}" class="text-base text-gray-200 hover:text-yellow-600 focus:outline-none  focus:ring-1 focus:ring-yellow-800 focus:border-yellow-600">
                    Live Demo
                  </a>
                </li>

                <li>
                  <a href="{{ route('home', '#pricing') }}" class="text-base text-gray-200 hover:text-yellow-600 focus:outline-none  focus:ring-1 focus:ring-yellow-800 focus:border-yellow-600">
                    Pricing
                  </a>
                </li>
                <li>
                  <a href="{{ route('home', '#contact') }}" class="text-base text-gray-200 hover:text-yellow-600 focus:outline-none  focus:ring-1 focus:ring-yellow-800 focus:border-yellow-600">
                    Contact
                  </a>
                </li>
              </ul>
