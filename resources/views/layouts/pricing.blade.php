...
<div class="bg-gray-100 rounded-2xl">
  <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
    ...
    <!-- Start of Bronze Pricing Plan box -->
      <div class="border bg-gradient-to-t from-dark-coffee to-white border-gray-300 rounded-lg shadow-sm divide-y divide-gray-200">
        ...
        <div class="p-6">
          ...
          <button class="inline-flex mt-8 w-full px-4 py-2 font-extrabold rounded-md shadow-sm text-white text-center bg-gradient-to-r from-blue-gray to-gray-400 hover:from-blue-gray hover:to-coffee focus:outline-none  focus:ring-1 focus:ring-dark-coffee focus:border-coffee"
          x-data="{}" x-on:click="window.livewire.emitTo('contact-modal', 'show')">
          Get Started
          </button>
          <!-- <a href="#" class="inline-flex mt-8 w-full px-4 py-2 font-extrabold rounded-md shadow-sm text-white text-center bg-gradient-to-r from-blue-gray to-gray-400 hover:from-blue-gray hover:to-coffee focus:outline-none  focus:ring-1 focus:ring-dark-coffee focus:border-coffee">
                    Get started
          </a> -->
        ...
        <div class="pt-6 pb-8 px-6 bg-coffee rounded-b-lg">
    ...
    <div class="border bg-gradient-to-t from-dark-coffee to-white  border-gray-300 rounded-lg shadow-sm divide-y divide-gray-200">
        ...
        <div class="bg-coffee pt-6 pb-8 px-6 rounded-b-lg">
          <h3 class="text-xs font-medium text-gray-900 tracking-wide uppercase">What's included</h3>
          <ul class="mt-6 space-y-4">
    ...
    <div class="border bg-gradient-to-t from-dark-coffee to-white  border-gray-300 rounded-lg shadow-sm divide-y divide-gray-200">
        <div class="p-6">
          ...
          <!-- <a href="" class="inline-flex mt-8 w-full px-4 py-2 font-extrabold rounded-md text-white text-center bg-gradient-to-r from-blue-gray to-gray-400 hover:from-blue-gray hover:to-coffee focus:outline-none  focus:ring-1 focus:ring-dark-coffee focus:border-coffee">
                    Get started
          </a> -->
          <!-- <a href="#" class="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-gray-900">Buy Hobby</a> -->
        </div>
