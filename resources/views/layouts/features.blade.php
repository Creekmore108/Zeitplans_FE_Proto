    ...
    <div class="bg-gradient-to-r from-yellow-600 to-yellow-800 rounded-2xl" >
      <div class="max-w-4xl mx-auto px-4 py-16 sm:px-6 sm:pt-20 sm:pb-24 lg:max-w-7xl lg:pt-24 lg:px-8">
        ...
        <div class="mt-12 grid grid-cols-1 gap-x-6 gap-y-12 sm:grid-cols-2 lg:mt-16 lg:grid-cols-4 lg:gap-x-8 lg:gap-y-16">
          ...
          <div>
            <div>
              <span class="flex items-center justify-center h-12 w-12 rounded-md bg-gray-900">
          ...
          <div>
            <div>
              <span class="flex items-center justify-center h-12 w-12 rounded-md bg-gray-800">
